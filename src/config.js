const config = {
	...
	projectcards: [
		{ go: "🚀 前往", img: "/img/sunshine.jpg", title: "lobe-chat", subtitle: "AI聊天站点（详细点开下方箭头）", text: "If you see this line, I've managed to get your attention.", url: "https://ai.lanni.site", show: false },
		{ go: "🗂️ 前往", img: "/img/sunshine.jpg", title: "music", subtitle: "音乐站调用网易云音乐（详细点开下方箭头）", text: "If you see this line, I've managed to get your attention.", url: "https://music.lanni.site", show: false },
		{ go: "📝 前往", img: "/img/sunshine.jpg", title: "chat", subtitle: "搭建的线上聊天站，叫上好友一起聊天吧！", text: "If you see this line, I've managed to get your attention.", url: "https://chat.lanni.site", show: false },
